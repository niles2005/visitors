(function() {
	...
	mapwork.serviceAddress = mapwork.serviceAddress0;
	mapwork.configs = {

        defaultLat:31.258706,
        defaultLon:121.833447,

        defaultZoom:16,
        
        "tileLayer_url":mapwork.serviceAddress + "gisserver/mt?v=" + mapwork.version,
